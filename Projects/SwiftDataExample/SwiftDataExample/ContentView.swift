            ...
            .toolbar {
                ...
                ToolbarItemGroup(placement: .topBarTrailing) {
                    Button("Save") {
                        ...
                        context.insert(expense) // Relies on autosave.
                        
//                        try! context.save() This is a way to manually call a save.
                        dismiss()
                    }
                }
            }
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                TextField("Value", value: $expense.value, format: .currency(code: "GBP"))
                    .keyboardType(.decimalPad)
            }
